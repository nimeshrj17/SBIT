...
export type DepthCarouselItem = string | { image: string; alt?: string; title?: string; count?: number };
    ...
    >
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          ...
          >
            <div className="depth-carousel__img-wrapper">
            ...
            {(item.title || item.count !== undefined) && (
                <div className="depth-carousel__content">
                    <span className="depth-carousel__icon">&#10086;</span>
                    {item.title && <h3 className="depth-carousel__title">{item.title}</h3>}
                    {item.count !== undefined && <p className="depth-carousel__count">{item.count} Products</p>}
                </div>
            )}
